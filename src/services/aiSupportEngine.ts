...
• সরাসরি এডমিনের সাথে কথা বলতে লিখুন: **এডমিন**`;
  ...
  // VIP Packages & Daily 10% Auto Profit
  else if (
    lower.includes('vip') ||
    ...
    reply = `👑 **RF SMM VIP প্যাকেজ ও দৈনিক ১০% অটো লাভ (Auto-Profit) সিস্টেম:**
...
👉 VIP প্যাকেজ কিনতে নিচে **"VIP প্যাকেজ"** বাটনে ট্যাপ করুন!`;
  ...
  // Withdrawal & Cashout
    ...
    reply = `💸 **টাকা উইথড্র / ক্যাশআউট (Withdrawal) করার নিয়ম:**
...
3. আপনার পার্সোনাল একাউন্ট নাম্বার এবং উইথড্র টাকার পরিমাণ (মিনিমাম ৳১০০) লিখুন।
...
💡 আপনার বর্তমান উইথড্রযোগ্য ব্যালেন্স: **৳${(userContext?.balance || 0).toFixed(2)}**`;
  }
