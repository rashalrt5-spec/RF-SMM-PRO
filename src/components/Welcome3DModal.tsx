...
export const Welcome3DModal: React.FC<Welcome3DModalProps> = ({
  ...
  userBalance,
  userTotalOrders,
  welcomeTitle = 'Welcome to RF SMM PANEL!',
  welcomeText = "Welcome to RF SMM PANEL. Welcome to Bangladesh's No. 1 Social Media Marketing Platform.",
  audioMode = 'tts',
  customAudioUrl,
  soundEnabled = true,
  siteLogo,
  ...
  // Pure Speech Synthesis with automatic language detection (English or Bengali)
  const speakWelcome = useCallback((textToSpeak: string) => {
    ...
    try {
      ...
      const hasBanglaChar = /[\u0980-\u09FF]/.test(textToSpeak);
